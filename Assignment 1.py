...
plt.plot(df_WestAfrica1["Year"], df_WestAfrica1["Benin"], label="Benin")
plt.plot(df_WestAfrica1["Year"], df_WestAfrica1["Burkina Faso"], label="Burkina Faso")
plt.plot(df_WestAfrica1["Year"], df_WestAfrica1["Cote d'Ivoire"], label="Cote d'Ivoire")
plt.plot(df_WestAfrica1["Year"], df_WestAfrica1["Cabo Verde"], label="Cabo Verde")
plt.plot(df_WestAfrica1["Year"], df_WestAfrica1["Ghana"], label="Ghana")
plt.plot(df_WestAfrica1["Year"], df_WestAfrica1["Guinea"], label="Guinea")
plt.plot(df_WestAfrica1["Year"], df_WestAfrica1["Gambia, The"], label="Gambia, The")
plt.plot(df_WestAfrica1["Year"], df_WestAfrica1["Guinea-Bissau"], label="Guinea-Bissau")
plt.plot(df_WestAfrica1["Year"], df_WestAfrica1["Liberia"], label="Liberia")
plt.plot(df_WestAfrica1["Year"], df_WestAfrica1["Mali"], label="Mali")
plt.plot(df_WestAfrica1["Year"], df_WestAfrica1["Mauritania"], label="Mauritania")
plt.plot(df_WestAfrica1["Year"], df_WestAfrica1["Niger"], label="Niger")
plt.plot(df_WestAfrica1["Year"], df_WestAfrica1["Nigeria"], label="Nigeria")
plt.plot(df_WestAfrica1["Year"], df_WestAfrica1["Senegal"], label="Senegal")
plt.plot(df_WestAfrica1["Year"], df_WestAfrica1["Sierra Leone"], label="Sierra Leone")
plt.plot(df_WestAfrica1["Year"], df_WestAfrica1["Togo"], label="Togo")
